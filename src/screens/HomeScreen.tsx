...
export const HomeScreen: React.FC = () => {
  ...
  const [activePanel, setActivePanel] = useState<'search' | 'external' | 'analysis' | 'ai'>('search');
  ...
  const {
    ...
    tracks: enhancedTracks as Track[],
    initialFilters: {
      bpmRange: [60, 200],
          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <Card className="p-4 bg-gray-900 border-gray-700">
              <div className="text-center mb-3">
                <h3 className="text-white font-semibold">Master Crossfader</h3>
              </div>
              <div className="flex items-center space-x-4">
                <span className="text-blue-400 font-bold">A</span>
                <div className="flex-1 bg-gray-700 h-4 rounded-full relative">
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-6 h-6 bg-white rounded-full shadow-lg cursor-pointer"></div>
                </div>
              ...
              <div className="flex justify-between mt-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-400 text-sm">Master Output</span>
                </div>
                <span className="text-gray-400 text-sm">100% Volume</span>
              </div>
            </Card>
